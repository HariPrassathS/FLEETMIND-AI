      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 px-6 sm:px-10 py-8 border-b border-white/10">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <p className="text-[10px] font-mono tracking-widest text-indigo-300 uppercase">FleetMind AI · Manager Analytics Portal</p>
              <h1 className="text-xl sm:text-2xl font-black text-white leading-tight">Executive BI & Cost Intelligence</h1>
            </div>
          </div>
          <p className="text-sm text-slate-400 font-medium ml-12">
            Strategic overview · Diesel benchmarking · SLA compliance · Net ROI · Carbon footprint
          </p>
        </div>
      </div>
