...
// Default seeded users for each role
export const SEED_USERS: UserProfile[] = [
  {
    id: 'user-admin-01',
    firebase_uid: 'uid-admin-fleetmind',
    email: 'admin@fleetmind.ai',
    full_name: 'Dr. Anand Ramanathan',
    role: 'ADMIN',
  ...
  {
    id: 'user-dispatcher-01',
    firebase_uid: 'uid-dispatcher-fleetmind',
    email: 'dispatcher@fleetmind.ai',
  ...
  {
    id: 'user-customer-01',
    firebase_uid: 'uid-customer-fleetmind',
    email: 'customer@fleetmind.ai',
    full_name: 'Rajesh Kumar (ABC Electronics)',
    role: 'CUSTOMER',
  ...
  {
    id: 'user-driver-01',
    firebase_uid: 'uid-driver-fleetmind',
    email: 'driver@fleetmind.ai',
  ...
  {
    id: 'user-manager-01',
    firebase_uid: 'uid-manager-fleetmind',
...
export const SEED_CUSTOMERS = [
  {
    id: 'cust-abc-electronics',
    user_id: 'user-customer-01',
    customer_type: 'BUSINESS' as const,
    company_name: 'ABC Electronics India Pvt Ltd',
    contact_name: 'Rajesh Kumar',
    email: 'customer@fleetmind.ai',
    phone: '+91 98410 44556',
    default_billing_address: '42 Peenya Industrial Area, Phase II',
    default_city: 'Bengaluru',
    created_at: new Date(Date.now() - 30 * 86400000).toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    id: 'cust-karur-textiles',
    user_id: 'user-customer-02',
    customer_type: 'BUSINESS' as const,
    company_name: 'Karur Home Textiles Export Corp',
    contact_name: 'Sundararajan V',
    email: 'contact@karurtextiles.com',
    phone: '+91 94433 12345',
    default_billing_address: '18 Thanthoni Textile Corridor',
    default_city: 'Karur',
    created_at: new Date(Date.now() - 25 * 86400000).toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    id: 'cust-chennai-auto',
    user_id: 'user-customer-03',
    customer_type: 'BUSINESS' as const,
    company_name: 'Apex Precision Engineering Ltd',
    contact_name: 'Karthik Narayanan',
    email: 'shipping@apexauto.in',
    phone: '+91 98840 98765',
    default_billing_address: 'Ambattur Industrial Estate Plot 78',
...
export const SEED_ALERTS: SystemAlert[] = [
  {
    ...
    type: 'DEADLINE_RISK',
    severity: 'HIGH',
    title: 'Tight SLA Window on Karur Textile Consignment',
    message: 'Shipment S-101 (2.2 Ton) scheduled for Chennai Sea Port CFS is within 4 hours of target dispatch buffer.',
  ...
  },
  {
    ...
    severity: 'CRITICAL',
    title: 'Lorry L-22 Maintenance Grounding',
    message: 'Vehicle TN-05-LM-4422 flagged alternator voltage fluctuation during pre-trip inspection. Grounded at Chennai depot.',
    lorry_id: 'lorry-19',
    is_read: false,
  ...
  },
  {
    ...
    severity: 'MEDIUM',
    title: 'Overweight Consignment S-999 Flagged',
    message: 'Consignment S-999 (32,000 kg) exceeds single-vehicle statutory limit of 28T. Requires multi-axle or split consignment.',
...
export const SEED_AUDIT_LOGS: AuditLog[] = [
  {
    ...
    entity: 'SETTINGS',
    entity_id: 'sys-settings-01',
    before_data: { fuel_price_per_liter: 94.00 },
    after_data: { fuel_price_per_liter: 96.50 },
  ...
  },
  {
    ...
    entity_id: 'opt-seed-01',
    before_data: { unassigned_shipments: 84 },
    after_data: { routes_generated: 12, cost_saved_inr: 48500 },
  ...
  },
  {
    ...
    after_data: { shipment_code: 'S-1042', weight_kg: 3200, destination: 'Hosur' },
...
class FleetMindStore {
  ...
  public createShipment(shipment: Partial<Shipment> & { description: string; weight_kg: number }): Shipment {
    ...
    const newShipment: Shipment = {
      ...
      pickup_address: shipment.pickup_address || 'Chennai Central Logistics Hub',
      ...
      destination_address: shipment.destination_address || 'Bengaluru Peenya Freight Station',
      ...
      sender_name: shipment.sender_name || 'Rajesh Kumar',
      ...
      receiver_name: shipment.receiver_name || 'Rahul Kumar',
